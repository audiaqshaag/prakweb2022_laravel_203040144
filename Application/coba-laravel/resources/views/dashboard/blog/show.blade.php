...
<div class="container">
    <div class="row my-4">
        <div class="col-lg-8">
           ...
           <a href="/dashboard/blog" style="margin-right:5px;" class="btn btn-dark" ><span data-feather="arrow-left"></span> Back To My Post</a>

           <a href="/dashboar/blog/{{ $post->slug }}/edit"  class="btn btn-warning"><span data-feather="plus"></span> Edit</a>
